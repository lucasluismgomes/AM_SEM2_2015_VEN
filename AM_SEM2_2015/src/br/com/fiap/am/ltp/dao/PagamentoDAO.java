...
public class PagamentoDAO {
	...
	/**
	 * Faz a gravação de um Pagamento efetuado com cartão no banco de dados. Veja a classe BO para
	 * entender as regras de negócio.
	 * 
	 * @author Victor 74820
	 * @since 1.0
	...
	/**
	 * Faz a gravação de um Pagamento efetuado com Cheque a Vista no banco de dados. Veja a classe BO para
	 * entender as regras de negócio.
	 * 
	 * @author Victor 74820
	 * @since 1.0
	...
	/**
	 * Faz a gravação de um Pagamento efetuado com Cheque Parcelado no banco de dados. Veja a classe BO para
	 * entender as regras de negócio.
	 * 
	 * @author Victor 74820
	 * @since 1.0
