        ...
        <div class="container" style="padding-top: 0px;">
			...
			<div class="row">
						...
						<input type="hidden" value="TRUE" name="navegador" = id="navegador">
							<div class="col-sm-12">
								<div class="row">
									<div class="col-sm-6 form-group">
										...
										<input type="text" placeholder="Nome completo" class="form-control" required="required" name="nmCliente" id="nmCliente">
									</div>
									<div class="col-sm-6 form-group">
										<label>CPF</label>
										<input type="number" placeholder="Digite seu CPF aqui" class="form-control" required="required" name="cpfCliente" id="cpfCliente">
									</div>
								</div>
								<div class="row">
									<div class="col-sm-6 form-group">
										<label>RG</label>
										<input type="text" placeholder="Digite seu RG aqui" class="form-control" required="required" name="rgCliente" id="rgCliente">
									</div>		
									<div class="col-sm-6 form-group">
										<label>Data de nascimento</label>
										<input type="date" placeholder="dd/mm/aaaa" class="form-control" required="required" name="dtNascimentoCliente" id="dtNascimentoCliente">
									</div>	
								</div>					
								<%-- <div class="row">
							...
							<div class="form-group">
								<label>E-mail</label>
								<input type="email" placeholder="exemplo@email.com.br" class="form-control" required="required" name="emailCliente" id="emailCliente">
							</div>
							<div class="form-group">
								<div class="row">
									<div class="col-sm-6 form-group">
										<label>Senha</label>
										<input type="password" placeholder="***********" class="form-control" required="required" name="senhaCliente" id="senhaCliente">
									</div>
									<div class="col-sm-6 form-group">
										<label>Confirmar senha</label>
										<input type="password" placeholder="***********" class="form-control" required="required" name="confirmaCliente" id="confirmaCliente">
									</div>
								</div>
							</div>
