		...
		try {
			...
			if (funcionalidade == 1) {
				...
				do {
					...
					cliente.setCodigo(Integer.parseInt(JOptionPane.showInputDialog("Digite o código do cliente")));
				...
				do {
					...
					cliente.setCodigo(Integer.parseInt(JOptionPane.showInputDialog("Digite o código do que será atualizado Cliente")));
				...
				do {
					...
					Cliente.setCodigo(Integer.parseInt(JOptionPane.showInputDialog("Digite o código do Cliente que será excluído?")));
